        ...
        {data.voices?.length > 0 && (
          <section className="mt-10">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3">
              {data.voices.map((v) => (
                <Link key={`${v.person.mal_id}-${v.language}`} href={`/person/${v.person.mal_id}`} className="rounded-xl bg-card border border-border overflow-hidden group hover:border-primary/30 transition-colors">
        ...
        {data.anime?.length > 0 && (
          <section className="mt-10">
            ...
            <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-3">
              {data.anime.map((a) => (
                <Link key={a.anime.mal_id} href={`/anime/${makeAnimeSlug(a.anime.title, a.anime.mal_id)}`} className="rounded-xl bg-card border border-border overflow-hidden group hover:border-primary/30 transition-colors">
                  <div className="aspect-[3/4] overflow-hidden">
